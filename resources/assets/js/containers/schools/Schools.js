...
export default class Schools extends Component {
  ...
  fetchSchools () {
    ...
    if (pathname === '/etablissements' || pathname === '/agences') {
      ...
      const requestUrl = 'http://opencartecomptable.herokuapp.com/public/api/etablissements' + url.search + isAgencies
      ...
      let url = this.props.location
      const requestUrl = 'http://opencartecomptable.herokuapp.com/public/api' + url.pathname
      axios.get(requestUrl)
        .then(school => {
